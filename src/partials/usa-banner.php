<?php
/**
 * Banner proclaiming that this is not an official US Government website
 *
 * @link https://components.designsystem.digital.gov/components/detail/banner--default.html
 */
?>
        ...
        <header class="usa-banner__header">
            <div class="usa-banner__inner">
                <div class="grid-col-auto">
                    <img class="usa-banner__header-flag" src="./assets/img/pirate_flag_small.png" alt="U.S. flag">
                </div>
                <div class="grid-col-fill tablet:grid-col-auto">
                    <p class="usa-banner__header-text"><strong>Not</strong> an official website of the United States government</p>
                ...
                <div class="usa-banner__guidance tablet:grid-col-6">
                    ...
                    <div class="usa-media-block__body">
                        <p>
                            ...
                            <br />
                            This website <strong>does not</strong> use .gov.
